...
/* Hybrid mode: set 1 untuk inject SSI extensions ke ClientHello */
extern "C" int g_ssi_client_mode;
...
{
    wolfSSL_Init();
    g_ssi_client_mode = 1; /* SSI client: inject SSI extensions */
