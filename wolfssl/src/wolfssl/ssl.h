...
#ifdef WOLFSSL_SSI_TLS
    WOLFSSL_CERT_TYPE_VC   = 3   /* Verifiable Credential (draft-vesco-vcauthtls) */
#endif
};
...
/* SSI-TLS: Load VC bytes as certificate for TLS 1.3 Certificate message */
WOLFSSL_API int wolfSSL_SSI_use_VC_buffer(WOLFSSL* ssl,
                            const unsigned char* vc, unsigned int vcSz);
/* SSI-TLS: Load Ed25519 key pair for CertificateVerify signing */
WOLFSSL_API int wolfSSL_SSI_use_Ed25519_key(WOLFSSL* ssl,
