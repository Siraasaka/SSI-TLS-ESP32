...
struct Options {
    ...
    /* SSI-TLS did_methods extension negotiation state */
    byte              ssiDIDMethodsTx[8];     /* DID methods we send */
    ...
    byte              ssiSendDIDMethods;      /* 1 = include did_methods ext */
    byte              ssiNegotiated;          /* 1 = SSI mode confirmed */
    byte              ssiVCMode;              /* 1 = using VC cert type */
